package dhh.action.generator.config;
...
public class JavaActionGeneratorConfiguration extends TypedPropertyHolder{
	 private String targetPackage;
	     ...
	     *  
	     */
	    public JavaActionGeneratorConfiguration() {
	        super();
	    }
	    ...
	    public XmlElement toXmlElement() {
	        XmlElement answer = new XmlElement("javaActionGenerator"); //$NON-NLS-1$
