...
import dhh.action.generator.config.JavaActionGeneratorConfiguration;
import dhh.jsp.generator.config.JsGeneratorConfiguration;
import dhh.jsp.generator.config.JspGeneratorConfiguration;
import dhh.service.generator.config.JavaIServiceGeneratorConfiguration;
import dhh.service.generator.config.JavaServiceImplGeneratorConfiguration;
...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_JAVA_ISERVICE_TYPE,
        ATTR_JAVA_SERVICE_IMPL_TYPE,
        ATTR_JS_TYPE,
        ATTR_JS_PACKAGE,
        ATTR_JS_TABLE_NAME_AT_RUNTIME,
        ATTR_JS_FILE_NAME,
        ATTR_JSP_TYPE,
        ATTR_JSP_FILE_NAME,
        ATTR_JSP_PACKAGE,
        ATTR_JSP_TABLE_NAME_AT_RUNTIME,
        ATTR_JAVA_ACTION_TYPE,
        ...
        ATTR_SELECT_BY_EXAMPLE_WITH_PAGE_STATEMENT_ID,
        ...
        ATTR_EXAMPLE_WHERE_CLAUSE_PAGE_ID,
    ...
    public String getSelectByExamplePageQueryId() {
        return tableConfiguration.getSelectByExamplePageQueryId();
    }
    ...
    public void initialize() {
        ...
        calculateJavaIServiceAttributes();
        calculateJavaServiceImplAttributes();
        calculateJsAttributes();
        calculateJspAttributes();
        calculateJavaActionAttributes();
    ...
    protected void calculateJavaIServiceAttributes() {
        ...
        setJavaIServiceType(sb.toString());
	}
    ...
    protected void calculateJavaServiceImplAttributes() {
        ...
        setJavaServiceImplType(sb.toString());
	}
   
    
    protected void calculateJavaActionAttributes() {
        ...
        sb.append(calculateJavaActionPackage());
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Action"); //$NON-NLS-1$
        setJavaActionType(sb.toString());
	}
    
    /**
     * 
     */
    protected void calculateJsAttributes() {
    	setJsFileName(calculatejsFileName());
    	setJsPackage(calculatejsPackage());
    	
    	setJsRuntimeTableName(calculateSqlMapFullyQualifiedRuntimeTableName());
    	
    }
    /**
     * 
     */
    protected void calculateJspAttributes() {
    	setJspFileName(calculatejspFileName());
        setJspPackage(calculatejspPackage());

        setJspRuntimeTableName(calculateSqlMapFullyQualifiedRuntimeTableName());
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByExampleWithPageStatementId("selectByExampleWithPage"); //$NON-NLS-1$
        ...
        setExampleWhereClausePageId("Example_Where_Clause_Page"); //��ҳ��ѯ����������
        setBaseColumnListId("Base_Column_List"); //$NON-NLS-1$
        setBlobColumnListId("Blob_Column_List"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId("Update_By_Example_Where_Clause"); //$NON-NLS-1$
    }

    public void setSelectByExampleWithPageStatementId(String s) {
    	internalAttributes.put(
                InternalAttribute.ATTR_SELECT_BY_EXAMPLE_WITH_PAGE_STATEMENT_ID, s);
	}

	public void setExampleWhereClausePageId(String s) {
    	 internalAttributes.put(InternalAttribute.ATTR_EXAMPLE_WHERE_CLAUSE_PAGE_ID,
                 s);
	}
    
    public String getExampleWhereClausePageId() {
	   	return internalAttributes
	    .get(InternalAttribute.ATTR_EXAMPLE_WHERE_CLAUSE_PAGE_ID);
	}
    ...
    public String getSelectByExampleWithPageStatementId() {
    	return internalAttributes
                .get(InternalAttribute.ATTR_SELECT_BY_EXAMPLE_WITH_PAGE_STATEMENT_ID);
	}
    ...
    public String getCountAllStatementId() {
    	return internalAttributes
    			.get(InternalAttribute.ATTR_COUNT_All_STATEMENT_ID);
    }
    ...
    protected String calculateJavaServiceInterfacePackage() {
    	JavaIServiceGeneratorConfiguration config = context
                .getJavaIServiceGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected String calculateJavaActionPackage() {
    	JavaActionGeneratorConfiguration config = context
                .getJavaActionGeneratorConfiguration();
        if (config == null) {
            return null;
        }
    ...
    protected String calculatejspPackage() {
        StringBuilder sb = new StringBuilder();
        JspGeneratorConfiguration config = context
                .getJspGeneratorConfiguration();
    ...
    protected String calculatejsPackage() {
    	StringBuilder sb = new StringBuilder();
    	JsGeneratorConfiguration config = context
    			.getJsGeneratorConfiguration();
    ...
    protected String calculatejspFileName() {
        StringBuilder sb = new StringBuilder();
        //TODO jsp首字母小写
        sb.append(fullyQualifiedTable.getDomainObjectName().toLowerCase());
        sb.append(".jsp"); //$NON-NLS-1$
        return sb.toString();
    }
    protected String calculatejsFileName() {
    	StringBuilder sb = new StringBuilder();
    	//TODO jsp首字母小写
    	sb.append(fullyQualifiedTable.getDomainObjectName().toLowerCase());
    	sb.append(".js"); //$NON-NLS-1$
    	return sb.toString();
    }
    ...
    public String getFullyQualifiedTableNameAtRuntime() {
    	String res=internalAttributes
                .get(InternalAttribute.ATTR_ALIASED_FULLY_QUALIFIED_TABLE_NAME_AT_RUNTIME);
        return res.substring(res.indexOf(".")+1,res.length());
    }

    /**
     *ԭ���� �����û����ı��� ��sa.table���ֽ����û���ȥ��
     * @return
     */
     ...
     * @return the list of generated XML files for this table
     */
    public abstract List<GeneratedTextFile> getGeneratedTextFiles();
    ...
    public void setJspRuntimeTableName(
    		String jspTableName) {
    	internalAttributes.put(
    			InternalAttribute.ATTR_JSP_TABLE_NAME_AT_RUNTIME,
    			jspTableName);
    }
    public String getJspRuntimeTableName() {
    	return internalAttributes.get(
    			InternalAttribute.ATTR_JSP_TABLE_NAME_AT_RUNTIME);
    }
    public void setJsRuntimeTableName(
    		String jsTableName) {
    	internalAttributes.put(
    			InternalAttribute.ATTR_JS_TABLE_NAME_AT_RUNTIME,
    			jsTableName);
    }
    public String getJsRuntimeTableName() {
    	return internalAttributes.get(
    			InternalAttribute.ATTR_JS_TABLE_NAME_AT_RUNTIME);
    }
    public void getSqlMapFullyQualifiedRuntimeTableName() {
    	internalAttributes.get(
    			InternalAttribute.ATTR_JSP_TABLE_NAME_AT_RUNTIME);
    }
    ...
    public void setJspPackage(String jspPackage) {
        internalAttributes.put(
                InternalAttribute.ATTR_JSP_PACKAGE,
                jspPackage);
    }
    ...
    public void setJsPackage(String jsPackage) {
    	internalAttributes.put(
    			InternalAttribute.ATTR_JS_PACKAGE,
    			jsPackage);
    }
    ...
    public void setJspFileName(String jspFileName) {
        internalAttributes.put(
                InternalAttribute.ATTR_JSP_FILE_NAME,
                jspFileName);
    }
    ...
    public void setJsFileName(String jsFileName) {
    	internalAttributes.put(
    			InternalAttribute.ATTR_JS_FILE_NAME,
    			jsFileName);
    }
    ...
    public String getJavaIServiceType() {
        return internalAttributes.get(
                InternalAttribute.ATTR_JAVA_ISERVICE_TYPE);
    }
    
    public String getJavaServiceImplType() {
        return internalAttributes.get(
                InternalAttribute.ATTR_JAVA_SERVICE_IMPL_TYPE);
    }

    public String getJsType() {
    	return internalAttributes.get(
    			InternalAttribute.ATTR_JS_TYPE);
    }
    public String getJavaActionType() {
        return internalAttributes.get(
                InternalAttribute.ATTR_JAVA_ACTION_TYPE);
    }

    public void setJavaIServiceType(String javaIServiceType) {
        internalAttributes.put(
                InternalAttribute.ATTR_JAVA_ISERVICE_TYPE,
                javaIServiceType);
    }
    
    public void setJavaServiceImplType(String javaServiceImplType) {
        internalAttributes.put(
                InternalAttribute.ATTR_JAVA_SERVICE_IMPL_TYPE,
                javaServiceImplType);
    }
    ...
    public void setJavaActionType(String javaActionType) {
        internalAttributes.put(
                InternalAttribute.ATTR_JAVA_ACTION_TYPE,
                javaActionType);
    }
