...
public class MyBatisGeneratorConfigurationParser {
    ...
    private void parseContext(Configuration configuration, Node node) {
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            } else if ("javaActionGenerator".equals(childNode.getNodeName())) { //$NON-NLS-1$
            	parseJavaActionGenerator(context, childNode);
            }else if ("jsGenerator".equals(childNode.getNodeName())) { //$NON-NLS-1$
            	parseJsGenerator(context, childNode);
            }else if ("jspGenerator".equals(childNode.getNodeName())) { //$NON-NLS-1$
            	parseJspGenerator(context, childNode);
    ...
    private void parseJavaIServiceGenerator(Context context, Node node) {
        ...
        javaIServiceGeneratorConfiguration.setConfigurationType(type);
        ...
        javaIServiceGeneratorConfiguration
    ...
    private void parseJavaServiceImplGenerator(Context context, Node node) {
        ...
        javaServiceImplGeneratorConfiguration
                .setImplementationPackage(implementationPackage);
    ...
    private void parseJavaActionGenerator(Context context, Node node) {
    	JavaActionGeneratorConfiguration javaActionGeneratorConfiguration = new JavaActionGeneratorConfiguration();

        context.setJavaActionGeneratorConfiguration(javaActionGeneratorConfiguration);
        ...
        javaActionGeneratorConfiguration.setConfigurationType(type);
        javaActionGeneratorConfiguration.setTargetPackage(targetPackage);
        javaActionGeneratorConfiguration.setTargetProject(targetProject);
        javaActionGeneratorConfiguration
                .setImplementationPackage(implementationPackage);
        ...
        for (int i = 0; i < nodeList.getLength(); i++) {
            ...
            if ("property".equals(childNode.getNodeName())) { //$NON-NLS-1$
                parseProperty(javaActionGeneratorConfiguration, childNode);
            }
        }
	}
	...
	private void parseJspGenerator(Context context, Node node) {
		JspGeneratorConfiguration jspGeneratorConfiguration = new JspGeneratorConfiguration();
		
		context.setJspGeneratorConfiguration(jspGeneratorConfiguration);
		
		Properties attributes = parseAttributes(node);
		String targetPackage = attributes.getProperty("targetPackage"); //$NON-NLS-1$
		String targetProject = attributes.getProperty("targetProject"); //$NON-NLS-1$
		
		jspGeneratorConfiguration.setTargetPackage(targetPackage);
		jspGeneratorConfiguration.setTargetProject(targetProject);
		...
		for (int i = 0; i < nodeList.getLength(); i++) {
			...
			if ("property".equals(childNode.getNodeName())) { //$NON-NLS-1$
				parseProperty(jspGeneratorConfiguration, childNode);
			}
		}
	}
	private void parseJsGenerator(Context context, Node node) {
		JsGeneratorConfiguration jsGeneratorConfiguration = new JsGeneratorConfiguration();
		
		context.setJsGeneratorConfiguration(jsGeneratorConfiguration);
		
		Properties attributes = parseAttributes(node);
		String targetPackage = attributes.getProperty("targetPackage"); //$NON-NLS-1$
		String targetProject = attributes.getProperty("targetProject"); //$NON-NLS-1$
		
		jsGeneratorConfiguration.setTargetPackage(targetPackage);
		jsGeneratorConfiguration.setTargetProject(targetProject);
		...
		for (int i = 0; i < nodeList.getLength(); i++) {
			...
			if ("property".equals(childNode.getNodeName())) { //$NON-NLS-1$
				parseProperty(jsGeneratorConfiguration, childNode);
			}
		}
	}
