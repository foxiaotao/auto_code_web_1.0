...
import org.mybatis.generator.api.TextFormatter;
...
public class Context extends PropertyHolder {
    ...
    private JavaActionGeneratorConfiguration javaActionGeneratorConfiguration;
    
    private JspGeneratorConfiguration jspGeneratorConfiguration;
    
    private JsGeneratorConfiguration jsGeneratorConfiguration;
    ...
    public JavaActionGeneratorConfiguration getJavaActionGeneratorConfiguration() {
        return javaActionGeneratorConfiguration;
    }
    ...
    public void validate(List<String> errors) {
        ...
        if (javaIServiceGeneratorConfiguration != null) {
        	javaIServiceGeneratorConfiguration.validate(errors, id);
        }
    ...
    public void setJavaActionGeneratorConfiguration(
    		JavaActionGeneratorConfiguration javaActionGeneratorConfiguration) {
        this.javaActionGeneratorConfiguration = javaActionGeneratorConfiguration;
    }
    
    public void setJavaIServiceGeneratorConfiguration(
    		JavaIServiceGeneratorConfiguration javaIServiceGeneratorConfiguration) {
    ...
    public XmlElement toXmlElement() {
        ...
        if (javaIServiceGeneratorConfiguration != null) {
            xmlElement.addElement(javaIServiceGeneratorConfiguration.toXmlElement());
        }
    ...
    public TextFormatter getTextFormatter() {
    	if (textFormatter == null) {
    		textFormatter = ObjectFactory.createTextFormatter(this);
    	}
    ...
    public void generateFiles(ProgressCallback callback,
            ...
            List<GeneratedXmlFile> generatedXmlFiles,List<GeneratedTextFile> generatedTextFiles, List<String> warnings)
            throws InterruptedException {
        ...
        if (introspectedTables != null) {
            for (IntrospectedTable introspectedTable : introspectedTables) {
                ...
                generatedTextFiles.addAll(introspectedTable
                		.getGeneratedTextFiles());
	...
	public JspGeneratorConfiguration getJspGeneratorConfiguration() {
		return jspGeneratorConfiguration;
	}

	public void setJspGeneratorConfiguration(JspGeneratorConfiguration jspGeneratorConfiguration) {
		this.jspGeneratorConfiguration = jspGeneratorConfiguration;
	}

	public JsGeneratorConfiguration getJsGeneratorConfiguration() {
		return jsGeneratorConfiguration;
	}

	public void setJsGeneratorConfiguration(JsGeneratorConfiguration jsGeneratorConfiguration) {
		this.jsGeneratorConfiguration = jsGeneratorConfiguration;
	}
}
