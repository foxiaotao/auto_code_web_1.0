...
import org.mybatis.generator.api.dom.DefaultTextFormatter;
...
public class ObjectFactory {
    ...
    public static TextFormatter createTextFormatter(Context context) {
    	String type = context.getProperty(PropertyRegistry.CONTEXT_TEXT_FORMATTER);
    	if (!StringUtility.stringHasValue(type)) {
    		type = DefaultTextFormatter.class.getName();
    	}
    	
    	TextFormatter answer = (TextFormatter) createInternalObject(type);
