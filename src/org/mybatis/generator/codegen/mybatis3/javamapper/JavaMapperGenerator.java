...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.CountAllMethodGenerator;
...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectByExampleWithPageMethodGenerator;
...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
	...
	protected void addCountAllMethod(Interface interfaze) {
		if (introspectedTable.getRules().generateCountByExample()) {
    ...
    protected void addBatchInsertMethod(Interface interfaze) {
    	if(introspectedTable.getGeneratedKey()!=null){//���û������GeneratedKey����ô�Ͳ����÷�������
	...
	@Override
	public AbstractJspGenerator getMatchedJspGenerator() {
		// TODO Auto-generated method stub
		return new JspGenerator();
	}
	@Override
	public AbstractJsGenerator getMatchedJsGenerator() {
		// TODO Auto-generated method stub
