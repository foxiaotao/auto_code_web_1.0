...
AbstractXmlElementGenerator{
    ...
    public void addElements(XmlElement parentElement) {
        ...
        if(jdbcConnectionConfiguration.getDriverClass().toLowerCase().contains("mysql")){
            ...
            answer.addElement(ifElement);
            answer.addElement(new TextElement("limit ${startPage},${rows}")); //$NON-NLS-1$

        }else if(jdbcConnectionConfiguration.getDriverClass().toLowerCase().contains("oracle")){
