...
public class ExampleWhereClauseElementPageGenerator extends
	AbstractXmlElementGenerator {
	//private boolean isForUpdateByExample;

    public ExampleWhereClauseElementPageGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer
        .addAttribute(new Attribute(
                "id", introspectedTable.getExampleWhereClausePageId()));
